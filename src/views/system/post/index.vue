  ...
  <a-card title="岗位管理" class="gi_page_card">
    <CwrsSplitPane>
      ...
      <a-row justify="space-between">
        ...
        <a-space wrap>
          <a-input-group>
            <a-select v-model="form.status" :options="options" placeholder="状态" allow-clear
              style="width: 150px"></a-select>
            <a-input v-model="form.username" placeholder="输入岗位名称搜索" allow-clear style="max-width: 250px">
              <template #prefix>
                <icon-search/>
              </template>
            </a-input>
